...
# Saving embeddings
path_save_embeddings= '/home/app/src/embeddings/mov_bal_4.2k_embeddings_15F/'
...
print(f'train embeddings saved OK')
...
print(f'test embeddings saved OK')
